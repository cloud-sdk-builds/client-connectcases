...
[`@aws-sdk/client-connectcases`](https://www.npmjs.com/package/@aws-sdk/client-connectcases/v/3.1041.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-connectcases@3.1041.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Lw2CVhl045hsNVObp0DRij/pBu+h9mmCLxzOAB37yow/diWWTpHI8c6gPIleDQCS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-connectcases": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-connectcases@3.1041.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-connectcases@3.1041.0/index.min.mjs": "sha384-Lw2CVhl045hsNVObp0DRij/pBu+h9mmCLxzOAB37yow/diWWTpHI8c6gPIleDQCS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-connectcases/blob/refs/tags/3.1041.0/LICENSE
```
